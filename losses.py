...
class StyleLoss(nn.Module):
    ...
    def __call__(self, x, y):
       ...
       # return style_loss.type(torch.FloatTensor)
        return style_loss
class PerceptualLoss(nn.Module):
    ...
    def __call__(self, x, y):
       ...
       # return content_loss.type(torch.FloatTensor)
        return content_loss
...
#这个我可以改，改成我自己定义的GAN
    def get_target_tensor(self, input, target_is_real):
        ...
        if target_is_real:
            ...
            if create_label:
                self.real_label_var = self.real_label
            target_tensor = self.real_label_var
        else:
            create_label = self.fake_label_var is None

            if create_label:
                self.fake_label_var= self.real_label
