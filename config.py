...
class Config(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.TRAIN_DIR = '/media/b3-542/disk/Datasets/Unalign'
        self._C.TRAINING.VAL_DIR = '/media/b3-542/disk/Datasets/old_photo_test/old_photo_test_4_7'
        self._C.TRAINING.TRAIN_UNALIGN_DIR = '/media/b3-542/disk/Datasets/old_photo_train'
        self._C.TRAINING.SAVE_DIR = 'checkpoints'
        self._C.TRAINING.TRAIN_PS = 1 #64
        self._C.TRAINING.VAL_PS = 1 #64

        # Override parameter values from YAML file first, then from override list.
        self._C.merge_from_file(config_yaml)
        self._C.merge_from_list(config_override)
        self._C.gpu_ids=[1]
        self._C.lr_policy='lambda'
